...
class BookmarksFragment : BaseFragment<BookmarksViewModel>() {
    ...
    private val articlesAdapter = ArticlesAdapter(
            {
                val dir = ArticlesFragmentDirections.actionNavArticlesToPageArticle(
                        it.id,
                        it.author,
                        it.authorAvatar,
                        it.category,
                        ...
                        it.title,
                        it.date)
                viewModel.navigate(NavigationCommand.To(dir.actionId, dir.arguments))
            },
            { id, isChecked ->
